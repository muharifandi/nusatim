...
class GetLeadDocumentsUseCase @Inject constructor(
    private val repository: LeadsRepository
) {
    operator fun invoke(id: Int): Flow<ResultState<List<LeadDocumentResponse>>> {
        return repository.getLeadDocuments(id)
    }
}
