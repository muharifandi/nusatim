...
class GetLeadRemindersUseCase @Inject constructor(
    private val repository: LeadsRepository
) {
    operator fun invoke(id: Int): Flow<ResultState<List<LeadReminderResponse>>> {
        return repository.getLeadReminders(id)
    }
}
